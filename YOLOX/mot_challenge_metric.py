...
#                    gt_instances[i]['visibility']
                    gt_instances[i]['truncation'],
                    gt_instances[i]['occlusion']
    ...
    def compute_metrics(self, results: list = None) -> dict:
        ...
        output_res = output_res['MotChallenge2DBox'][self.TRACKER]['COMBINED_SEQ']['pedestrian']
    ...
    def get_dataset_cfg(self, gt_folder: str, tracker_folder: str):
        ...
        dataset_config = dict(
            ...
            CLASSES_TO_EVAL=['pedestrian', 'car', 'van','truck','bus'],
